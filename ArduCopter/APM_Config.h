...
#define USERHOOK_VARIABLES "Ultrasunete.h"
// Put your custom code into the UserCode.pde with function names matching those listed below and ensure the appropriate #define below is uncommented below
#define USERHOOK_INIT ultrasunete_init();                      // for code to be run once at startup
//#define USERHOOK_FASTLOOP userhook_FastLoop();            // for code to be run at 100hz
#define USERHOOK_50HZLOOP ultrasunete_50Hz();                  // for code to be run at 50hz
//#define USERHOOK_MEDIUMLOOP ultrasunete_MediumLoop();        // for code to be run at 10hz
